(function ($) {
    ...
    $('.laundryka-quantity').append('<button class="up qtybtn"><i class="fa fa-angle-up"></i></button>');
    $('.laundryka-quantity').prepend('<button class="down qtybtn"><i class="fa fa-angle-down"></i></button>');
